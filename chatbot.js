(function() {
  ...
  container.innerHTML = `
    <div id="custom-chat-icon">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" width="28px" height="28px"><path d="M0 0h24v24H0z" fill="none"/><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-2 12H6v-2h12v2zm0-3H6V9h12v2zm0-3H6V6h12v2z"/></svg>
    </div>
  ...
  style.textContent = `
    ...
    #custom-chat-icon {
      ...
      background-color: #007AFF; /* iOS Blue - Or your brand color */
      color: white;
      border-radius: 50%;
      cursor: pointer;
      display: flex;
